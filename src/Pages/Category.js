...
function Category() {
    ...
    //             order: `${filter.toLocaleLowerCase()}`
    //         })}`
    //     });
    // }, [filter])
    ...
    useEffect(() => {
        async function getData() {
            try {
                const response = await axios.get(`/menu/by?category=${searchParams.get('cat')}&subCategory=${searchParams.get('subCat')}`);
                        ...
                        {show &&
                            <div className="absolute z-10 w-36 right-0 bg-white rounded divide-y divide-gray-100 shadow">
                                <ul className="text-xs text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                                    ...
                                    <li onClick={() => { setFilter('Tazeden kona'); showFilter(false) }} className='cursor-pointer flex items-center hover:bg-gray-100'>
                                    ...
                                    <li onClick={() => { setFilter('Arzandan gymmada'); showFilter(false) }} className='cursor-pointer flex items-center hover:bg-gray-100'>
                                    ...
                                    <li onClick={() => { setFilter('Gymmatdan arzana'); showFilter(false) }} className='cursor-pointer flex items-center hover:bg-gray-100'>

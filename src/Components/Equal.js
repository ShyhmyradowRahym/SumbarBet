        ...
        <div className='w-full text-white md:h-32 h-44 bg-gray-800 fixed bottom-0 z-10'>
            <div className='container h-full mx-auto grid lg:grid-cols-3 lg:grid-gap-3 grid-cols-1 grid-gap-1'>
                ...
                <div className='flex items-center justify-center'>
                    {equalProducts[0].e.img && <img src={equalProducts[0].e.img} className='lg:h-20 h-12 md:mx-2 mx-1' />}
                    {equalProducts[1] && equalProducts[1].e.img ? <img src={equalProducts[1].e.img} className='lg:h-20 h-12 md:mx-2 mx-1' /> : <img src='https://sumbar-computer.com/img/temp/product-xs.png' className='lg:h-20 h-12 md:mx-2 mx-1' />}
                    {equalProducts[2] && equalProducts[2].e.img ? <img src={equalProducts[2].e.img} className='lg:h-20 h-12 md:mx-2 mx-1' /> : <img src='https://sumbar-computer.com/img/temp/product-xs.png' className='lg:h-20 h-12 md:mx-2 mx-1' />}
                    {equalProducts[3] && equalProducts[3].e.img ? <img src={equalProducts[3].e.img} className='lg:h-20 h-12 md:mx-2 mx-1' /> : <img src='https://sumbar-computer.com/img/temp/product-xs.png' className='lg:h-20 h-12 md:mx-2 mx-1' />}
                </div>
                <div className='flex items-center justify-center'>
                    <div className='flex items-center justify-center'>
